...
@section('page_header')
    <div class="container-fluid">
        ...
        @can('edit', app($dataType->model_name))
            <a id="print-table" class="btn btn-warning btn-add-new">
                <i class="voyager-cloud-download"></i> <span>{{ __('Print') }}</span>
            </a>
        @endcan
...
@section('javascript')
    ...
    <script>
         $('#print-table').click(function (e) {
               ...
               $('td#bread-actions').hide();
               $('th.actions').hide();
               $('input[type="checkbox"]').hide();

               setTimeout(function () {
                    $('td#bread-actions').show();
                    $('th.actions').show();
               ...
               $('table').printThis({
                    ...
                    loadCSS: "css/voyager.css",
                    pageTitle: "Data Barang Masuk", // add title to print page
               });
          });
